    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.titleRow}>
          <Text style={styles.title}>Central Planning</Text>
          <View style={styles.pillarBadge}><Text style={styles.pillarText}>P4</Text></View>
        </View>

        <View style={styles.statStrip}>
          <Text style={styles.statNum}>{active}</Text>
          <Text style={styles.statLabel}>of {list.length} active</Text>
        </View>
        ...
        <Pressable style={styles.addToggle} onPress={() => setShowAdd(true)}>
          <Text style={styles.addToggleText}>Add CPC member</Text>
        </Pressable>
      </ScrollView>
