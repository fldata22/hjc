  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        <FormHeader title="Daily Expenses" pillar="Budget" statNum={`₵${daySpend.toFixed(0)}`} statLabel={`spent today · ₵${budgetRemaining.toFixed(0)} of ₵${totalBudget.toFixed(0)} remaining`} />
        ...
        <AddButton label="Add expense" onPress={() => setShowForm(true)} />
      </ScrollView>
