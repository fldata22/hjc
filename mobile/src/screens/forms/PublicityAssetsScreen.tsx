    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.titleRow}>
          <Text style={styles.title}>Publicity & Video</Text>
          <View style={styles.pillarBadge}><Text style={styles.pillarText}>A·all</Text></View>
        </View>

        <View style={styles.statStrip}>
          <Text style={styles.statNum}>{deployedCount}</Text>
          <Text style={styles.statLabel}>of {list.length} deployed</Text>
        </View>
        ...
        <Pressable style={styles.addToggle} onPress={() => setShowForm(true)}>
          <Text style={styles.addToggleText}>Add asset</Text>
        </Pressable>
      </ScrollView>
